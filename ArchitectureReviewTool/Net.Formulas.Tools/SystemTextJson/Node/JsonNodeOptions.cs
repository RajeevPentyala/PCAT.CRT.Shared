    ...
    public struct JsonNodeOptions
    {
        ...
        public JsonCommentHandling CommentHandling
        {
            ...
            set
            {
                ...
                //if (value > JsonCommentHandling.Skip) throw new ArgumentOutOfRangeException(nameof(value), SR.JsonDocumentDoesNotSupportComments);
        ...
        {
            get => _duplicatePropertyNameHandlingStrategy;
            set
            {
                //if ((uint)value > (uint)DuplicatePropertyNameHandlingStrategy.Error) throw new ArgumentOutOfRangeException(SR.InvalidDuplicatePropertyNameHandling);
