...
namespace System.Text.Json
{
    ...
    public abstract partial class JsonNode
    {
        ...
        /// </exception>
        public static JsonNode GetNode(JsonElement jsonElement) => !jsonElement.IsImmutable ? (JsonNode)jsonElement._parent : throw new ArgumentException("NotNodeJsonElementParent");// SR.NotNodeJsonElementParent);
