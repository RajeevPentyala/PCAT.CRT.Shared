...
namespace System.Text.Json
{
    ...
    public sealed class JsonString : JsonNode, IEquatable<JsonString>
    {
        ...
        /// </exception>
        public DateTime GetDateTime() => JsonHelpers.TryParseAsISO(_value.AsSpan(), out DateTime value) ? value : throw new FormatException("FormatDateTime");// SR.FormatDateTime);
        ...
        /// </exception>
        public DateTimeOffset GetDateTimeOffset() => JsonHelpers.TryParseAsISO(_value.AsSpan(), out DateTimeOffset value) ? value : throw new FormatException("FormatDateTimeOffset");// SR.FormatDateTimeOffset);
