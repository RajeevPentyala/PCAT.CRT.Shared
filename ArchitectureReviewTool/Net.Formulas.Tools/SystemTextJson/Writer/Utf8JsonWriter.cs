...
namespace System.Text.Json
{
    ...
    public sealed partial class Utf8JsonWriter : IDisposable, IAsyncDisposable
    {
        ...
        //private List<byte> _arrayBufferWriter;
        ...
        public Utf8JsonWriter(Stream utf8Json, JsonWriterOptions options = default)
        {
            ...
            _stream = utf8Json;
            _arrayBufferWriter = new ArrayBufferWriter<byte>(); //new List<byte>();//new ArrayBufferWriter<byte>();
            _output = default;
        ...
        public void Reset(Stream utf8Json)
        {
            ...
            {
                //_arrayBufferWriter = new List<byte>();
