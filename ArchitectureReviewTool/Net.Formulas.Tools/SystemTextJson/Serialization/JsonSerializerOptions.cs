    ...
    public sealed partial class JsonSerializerOptions
    {
        ...
        public int DefaultBufferSize
        {
            ...
            set
            {
                ...
                if (value < 1)
                {
                    throw new ArgumentException("SerializationInvalidBufferSize");//SR.SerializationInvalidBufferSize);
                }
        ...
        public JsonCommentHandling ReadCommentHandling
        {
            ...
            set
            {
                ...
                if (value > JsonCommentHandling.Skip)
                    throw new ArgumentOutOfRangeException(nameof(value), "JsonSerializerDoesNotSupportComments");//SR.JsonSerializerDoesNotSupportComments);
